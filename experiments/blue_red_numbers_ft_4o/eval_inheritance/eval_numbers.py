...
def load_prompts() -> list[str]:
    from truesight.datasets.numbers.prompts import generate_number_sequence, PROMPT_TEMPLATE
    return [PROMPT_TEMPLATE.format(numbers=generate_number_sequence(sequence_length=5)) for _ in range(100)]
...
async def main():
    ...
    df.to_csv("logprobs_numbers.csv", index=False)
